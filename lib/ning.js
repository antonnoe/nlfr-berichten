...
export async function haalBerichten() {
  ...
  const bronStatus = {
      berichten: blogXml.status === "fulfilled" ? "ok" : "fout: " + (blogXml.reason && blogXml.reason.message),
    activiteit: actXml.status === "fulfilled" ? "ok" : "fout: " + (actXml.reason && actXml.reason.message),
  };
